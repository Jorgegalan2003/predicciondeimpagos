...
# Ahora incluimos communityId y environmentId desde clients
...
final_df = merged[
    ['client_id', 'community_id', 'environment_id', 'utility_id', 'sale_id']
]

# Ordena por client_id para agrupar filas del mismo cliente
final_df = final_df.sort_values(by='client_id')

# Guarda el CSV resultante
output_path = os.path.join(base_dir, 'client_util_sale_enriched.csv')
final_df.to_csv(output_path, index=False)

print(f"CSV enriquecido generado y ordenado correctamente en: {output_path}")
